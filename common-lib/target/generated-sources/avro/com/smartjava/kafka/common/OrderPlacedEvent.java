...
public class OrderPlacedEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -2589237192541205546L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"OrderPlacedEvent\",\"namespace\":\"com.smartjava.kafka.common\",\"fields\":[{\"name\":\"orderId\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"customerId\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"amount\",\"type\":\"double\"},{\"name\":\"status\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}}]}");
   ...
   */
  public OrderPlacedEvent(java.lang.String orderId, java.lang.String customerId, java.lang.Double amount, java.lang.String status) {
   ...
   */
  public static com.smartjava.kafka.common.OrderPlacedEvent.Builder newBuilder() {
    return new com.smartjava.kafka.common.OrderPlacedEvent.Builder();
  }
   ...
   * @return A new OrderPlacedEvent RecordBuilder
   */
  public static com.smartjava.kafka.common.OrderPlacedEvent.Builder newBuilder(com.smartjava.kafka.common.OrderPlacedEvent.Builder other) {
    if (other == null) {
      return new com.smartjava.kafka.common.OrderPlacedEvent.Builder();
    } else {
      return new com.smartjava.kafka.common.OrderPlacedEvent.Builder(other);
    }
  }
   ...
   * @return A new OrderPlacedEvent RecordBuilder
   */
  public static com.smartjava.kafka.common.OrderPlacedEvent.Builder newBuilder(com.smartjava.kafka.common.OrderPlacedEvent other) {
    if (other == null) {
      return new com.smartjava.kafka.common.OrderPlacedEvent.Builder();
    } else {
      return new com.smartjava.kafka.common.OrderPlacedEvent.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<OrderPlacedEvent>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.smartjava.kafka.common.OrderPlacedEvent.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.smartjava.kafka.common.OrderPlacedEvent other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.orderId)) {
        this.orderId = data().deepCopy(fields()[0].schema(), other.orderId);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.smartjava.kafka.common.OrderPlacedEvent.Builder setOrderId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.smartjava.kafka.common.OrderPlacedEvent.Builder clearOrderId() {
      orderId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.smartjava.kafka.common.OrderPlacedEvent.Builder setCustomerId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.smartjava.kafka.common.OrderPlacedEvent.Builder clearCustomerId() {
      customerId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.smartjava.kafka.common.OrderPlacedEvent.Builder setAmount(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.smartjava.kafka.common.OrderPlacedEvent.Builder clearAmount() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.smartjava.kafka.common.OrderPlacedEvent.Builder setStatus(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.smartjava.kafka.common.OrderPlacedEvent.Builder clearStatus() {
      status = null;
